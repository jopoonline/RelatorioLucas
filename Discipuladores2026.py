...
st.markdown("""<style>
    ...
    /* Estilos para Centralização Mobile */
...
# --- ABA LANÇAR (MODIFICADA PARA MOBILE CENTRALIZADO) ---
with tab_lanc:
    if st.session_state.membros_cadastrados:
        ...
        # Inicialização do estado de presença para botões
        ...
        def criar_linha_mobile(nome, tipo):
            ...
            # Botões de Ícones Lado a Lado Centralizados
        ...
        # Gerar linhas para Líder e Membros
        ...
        if st.button("💾 SALVAR LANÇAMENTO", use_container_width=True, type="primary"):
            novos = []
            # Coletar dados dos botões do Líder
            novos.append({
            ...
            if salvar_seguro("Presencas", dfp) and salvar_seguro("Visitantes", dfv): 
                ...
                st.session_state.presencas_bt = {} # Limpa cache
                time.sleep(1)
